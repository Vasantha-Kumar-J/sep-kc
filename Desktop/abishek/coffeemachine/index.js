...
async function cup()
{      if(document.getElementById('water-level').value<30 || document.getElementById('bean-level').value<30 || document.getElementById('milk-level').value<30)
       {  window.alert("machine cant be worked because of low level of ingredients")
    return;
      }
       let selectedOption=''
